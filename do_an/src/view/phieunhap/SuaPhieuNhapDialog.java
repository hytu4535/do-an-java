...
public class SuaPhieuNhapDialog extends JDialog {
    ...
    private String[] Hienthi = {"Mã phiếu:", "Người tạo:", "Mã nhà cung cấp:", "Tổng tiền:", "Thời gian tạo:"};
    private JDateChooser dcNgay;
    
    private PhieuNhap phieu;// dùng để lấy mã phiếu nhập cần sửa
    private PhieuNhap phieuNhap = new PhieuNhap();// dùng để lưu các giá trị nhập để cập nhật phiếu theo cái này
    ...
    public SuaPhieuNhapDialog(JFrame parent, PhieuNhap phieu) {
        ...
        // điều chỉnh cho mã nhà cung cấp không đổi được
        this.txtfNhap.get(2).setEditable(false);
        
        this.txtfNhap.get(2).setText(this.phieu.getMaNhaCungCap());
        ...
        btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if( validateTextFields() ) {
                    phieuNhap.setMaPhieu(phieu.getMaPhieu());
                    
                    phieuNhap.setNguoiTao(txtfNhap.get(1).getText());
                    
                    phieuNhap.setMaNhaCungCap(txtfNhap.get(2).getText());
                    
                    phieuNhap.setTongTien( Double.parseDouble(txtfNhap.get(3).getText()) );
                    
                    phieuNhap.setThoiGianTao(new Timestamp(dcNgay.getDate().getTime()));
    ...
    private boolean validateTextFields() {
        ...
        try {
            double test = Double.parseDouble(this.txtfNhap.get(3).getText());
