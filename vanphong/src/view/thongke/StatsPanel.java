...
public class StatsPanel extends JPanel {
    public StatsPanel() {
        ...
        JLabel productCountLabel = new JLabel(String.valueOf(productCount), SwingConstants.CENTER);
        ...
        JLabel supplierCountLabel = new JLabel(String.valueOf(supplierCount), SwingConstants.CENTER);
        ...
        JLabel userCountLabel = new JLabel(String.valueOf(userCount), SwingConstants.CENTER);
