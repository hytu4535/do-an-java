...
public class TablePanel extends JPanel {
    ...
    // Cấu trúc cột
    private final String[] productColumns = {"STT", "Mã máy", "Tên máy", "Số lượng nhập", "Số lượng xuất"};
    private final String[] ticketColumns = {"STT", "Mã phiếu", "Loại phiếu", "Ngày tạo", "Tổng tiền"};
    private final String[] userColumns = {"STT", "Tên tài khoản", "Họ tên", "Vai trò", "Trạng thái"};
    ...
    public void adjustColumnWidths(String tableType) {
        ...
        if (tableType.equals("Sản phẩm")) {
            ...
            columnModel.getColumn(1).setPreferredWidth(80);  // Mã máy
