...
public class ChiTietPhieuXuatDialog extends JDialog {
    private ChiTietPhieuXuat pnlContent;
    ...
    public ChiTietPhieuXuatDialog(JFrame owner, String title, boolean modal) {
    ...
    public void InitContent() {
        this.pnlContent = new ChiTietPhieuXuat();
    ...
    public ChiTietPhieuXuat getPnlContent() {
        return pnlContent;
    }
